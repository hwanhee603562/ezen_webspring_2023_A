...
public class LombokTest {
    public static void main(String[] args) {
        ...
        //ConsoleDto consoleDto4 = new ConsoleDto( true, 0, LocalDate.now() );
        ...
        // 빌더 패턴 : 복잡한 객체 생성과정[ 생성자 ]를 다양한 구성의 객체를 만드는 패턴 지원
            // LombokDto.builder().~.~.build();
        LombokDto lombokDto3 = LombokDto.builder().title("공부").finished(true).build();
        LombokDto lombokDto4 = LombokDto.builder().dueDate( LocalDate.now() ).tno(0).build();
