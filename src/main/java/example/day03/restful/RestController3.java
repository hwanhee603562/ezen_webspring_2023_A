...
public class RestController3 {
    // 1. GET
    @RequestMapping( value = "/example/day03/red", method= RequestMethod.GET )
    ...
    // 2. POST
    @RequestMapping( value = "/example/day03/red", method= RequestMethod.POST )
    ...
    // 3. PUT
    @RequestMapping( value = "/example/day03/red", method= RequestMethod.PUT )
    ...
    // 4. DELETE
    @RequestMapping( value = "/example/day03/red", method= RequestMethod.DELETE )
