...
public class RestController4 {
    // 1. GET
    @GetMapping("/example/day03/blue")    // @RequestMapping과 기능은 동일하지만 더 이후에 나온 것으로 짧게 줄일 수 있음
    ...
    // 2. POST
    @PostMapping("/example/day03/blue")
    ...
    // 4. DELETE
    @DeleteMapping("/example/day03/blue")
